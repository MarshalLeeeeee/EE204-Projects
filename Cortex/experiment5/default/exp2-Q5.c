...
volatile uint16_t systick_10ms_couter,systick_100ms_couter, systick_200ms_couter;
volatile uint8_t	systick_10ms_status,systick_100ms_status, systick_200ms_status;
...
int main(void)
{
  ...
  SysTickPeriodSet(ui32SysClock/SYSTICK_FREQUENCY);
   ...
   IntMasterEnable();
	...
	while (1)
	{
		if(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0) == 0x0 && GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_1) == 0)
		{
			cnt_en = 0;
