...
volatile uint8_t rightshift = 0x81,rightshift2 = 0x01;
...
int main(void)
{
  ...
  SysTickPeriodSet(ui32SysClock/SYSTICK_FREQUENCY);
   ...
   IntMasterEnable();
	...
	while (1)
	{
		if(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0) == 0x0)
		{
				Delay(80000);
				if(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0) == 0x0)
		...
		switch(state)
		{
				case 0:I2C_FLASHTIME = 500;break;
				case 1:I2C_FLASHTIME = 1000;break;
				case 2:I2C_FLASHTIME = 2000;break;
				case 3:I2C_FLASHTIME = 200;break;
		}
		...
		result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,rightshift2);
		Delay(40000);
		result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0x00);
		result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[cnt == 0? 8:cnt]);
		result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,(rightshift & (~rightshift2)));
		Delay(40000);
	}
